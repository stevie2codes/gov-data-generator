...
interface ConfigPanelProps {
  onGenerate: (type: string, count: number, fields: string[]) => void;
  onPreview: (type: string, count: number, fields: string[]) => void;
...
export function ConfigPanel({ onGenerate, onPreview, isGenerating }: ConfigPanelProps) {
    ...
    <Card className="w-full max-w-md">
      ...
      <CardContent className="space-y-6">
        <div className="space-y-2">
          ...
          <Select value={selectedType} onValueChange={handleTypeChange}>
            ...
            <SelectContent>
              ...
              <SelectItem value="employees">Government Employees</SelectItem>
              <SelectItem value="services">Public Services</SelectItem>
              <SelectItem value="contracts">Government Contracts</SelectItem>
              <SelectItem value="assets">Municipal Assets</SelectItem>
              <SelectItem value="budget">Budget Records</SelectItem>
              <SelectItem value="permits">Permits & Applications</SelectItem>
        ...
        <div className="flex gap-2">
          <Button
            onClick={() => onPreview(selectedType, recordCount, selectedFields)}
            variant="outline"
            className="flex-1"
          ...
          <Button
            onClick={() => onGenerate(selectedType, recordCount, selectedFields)}
            disabled={isGenerating || selectedFields.length === 0}
            className="flex-1"
          >
